...
public class BufferedReaderExample {
	...
	public static void main(String[] args) {
		String file = "runs/scenario2_run";
		try 
		{
			BufferedReader br1 = new BufferedReader(new FileReader(file+"01.csv"));
			BufferedReader br2 = new BufferedReader(new FileReader(file+"02.csv"));
			BufferedReader br3 = new BufferedReader(new FileReader(file+"03.csv"));
			BufferedReader br4 = new BufferedReader(new FileReader(file+"04.csv"));
			BufferedReader br5 = new BufferedReader(new FileReader(file+"05.csv"));
			...
			FileWriter fw = new FileWriter(file.substring(0, file.length()-3) + "avgTotal.csv");
			String sCurrentLine;
