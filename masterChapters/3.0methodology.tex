...
Robots will be pushed if a different robot is moving against it. Two robots can not occupy the same space at the same time. Simulated Boids can overlap without affecting each other.