...
\end{tabular}
\caption{Table comparing neighborhood distances between robots and simulated Boids}
\end{table}
...
Obstacle        & 3x        & 150    \\ \hline
\end{tabular}
\caption{Table comparing weights applied to behaviors between robots and simulated Boids}
\end{table}