...
The method used to measure the velocity of the robot is highly imprecise, when logging the velocity of a robot with constant max velocity, the results did not stay consistently at a given number. 

The velocity results that the watcher software produced is shown in figure \ref{fig:speed}, the robot is moving at max speed the whole time 
