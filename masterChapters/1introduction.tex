...
%The CRAB lab at the AI department at NTNU have created a robot called the ChIRP robot. These robots are open source and can easily be mass produced. These robots can easily be expanded with other types of sensors, but only distance sensors and light sensors are available right now.
%
